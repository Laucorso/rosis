...
<div class="card-header d-flex align-items-center justify-content-between py-3">
    <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-magic"></i> Componente</h6>
...
<div class="card-body">
    <div class="row mb-2">
        ...
        <div class="col-8">
            <input type="text" class="form-control form-control-sm" name="product_tags" placeholder="Etiquetas separadas por |">
        </div>
    </div>
    <div class="row mb-2">
    ...
    <div class="row">
        <div class="col-2">
            <div class="form-group">
                <label for="product_images">Imagen 1:1</label>
