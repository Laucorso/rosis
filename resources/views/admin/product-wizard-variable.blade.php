...
<div class="card-header d-flex align-items-center justify-content-between py-3">
    <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-magic"></i> Variable {{$type}}</h6>
    <div class="form-group float-right m-0">
        <div class="custom-control custom-switch">
            <input type="checkbox" name="active" class="custom-control-input" id="customSwitch1">
            <label class="custom-control-label" for="customSwitch1">visible en web</label>
        </div>
    </div>    
</div>
<div class="card-body">
    ...
    <div class="row mb-2">
        <div class="col-6">
            <input type="text" class="form-control form-control-sm" name="product_sizes" placeholder="Tamaños separados por |">
        </div>
        <div class="col-6">
            <input type="text" class="form-control form-control-sm" name="product_colors" placeholder="Colores separados por |">
        </div>
    </div>
    <div class="row">
        <div class="col-2">
            <div class="form-group">
                <label for="product_images">Imagen principal 4:5</label>
                <div id="product_images"></div>
            </div>    
        </div>
        <script>
            var productImages = new XMMDropbox('product_images',{extensions:['webp','gif','png','jpg','jpeg','svg'],preview:true,multiple:false})
        </script>
    </div>
    <div class="row">
        <div class="col-12">
            <button class="btn btn-sm btn-success float-right" type="submit" name="cmd" value="next">Siguiente</button>
        </div>
    </div>
</div>
