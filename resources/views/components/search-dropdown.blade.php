...
<div class="dropdown">
    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdown_coins" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        {{$name}}
    </button>
    <div id="menu" class="dropdown-menu p-3" aria-labelledby="dropdown_coins">
        <form class="px-4 py-2">
            <input type="search" class="form-control" id="searchCoin" placeholder="Select Coin..." autofocus="autofocus">
        </form>
...
<script type="text/javascript">
    ...
    let items = document.getElementsByClassName("xxitem")
    function buildDropDown(values) {
        let contents = []
        for (let name of values) {
            contents.push('<input type="button" class="dropdown-item xxitem" type="button" value="' + name + '"/>')
        }
    ...
    $('#menuItems').on('click', '.xxitem', function(){
